...
from src.config import get_vector_store_batch_size, get_vector_store_inter_batch_sleep_sec
...
EMBEDDING_BATCH_SIZE = get_vector_store_batch_size()

# 两次外层批次之间的等待时间（秒），避免瞬间并发过高
INTER_BATCH_SLEEP_SEC = get_vector_store_inter_batch_sleep_sec()
